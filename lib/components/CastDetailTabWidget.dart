              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    4.height,
                    Text('${language!.as} ${data.characterName.validate()}', style: secondaryTextStyle(color: Colors.grey.shade500)),
                    4.height,
                    Text(data.releaseYear.validate(), style: primaryTextStyle(color: Colors.grey.shade500)),
                  ],
