        ...
        if (_permissionReady) {
          ...
          await InternetFile.get(
            ...
            progress: (receivedLength, contentLength) {
              appStore.setDownloadPercentage((((receivedLength / contentLength) * 100).toInt()));
            },
          ).then((value) async {
            ...
            data.duration = widget.movie != null ? widget.movie!.runTime.validate() : widget.episode!.runTime.validate();
        ...
        return Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              if (appStore.downloadedItemList.any((e) => e.id == (movie != null ? movie!.id.validate() : episode!.id.validate())) && !appStore.isDownloading) Icon(Icons.check, color: colorPrimary, size: 32),
            ],
          ),
        );
      },
