...
import '../fragments/DownloadScreen.dart';
        ...
        bottomNavigationBar: Container(
          ...
          child: NavigationBar(
            ...
            destinations: [
              ...
              NavigationDestination(
                icon: Image.asset(ic_down,
                    fit: BoxFit.fitHeight,
                    color: Colors.white,
                    height: 20,
                    width: 20),
                selectedIcon: Image.asset(ic_down,
                    color: colorPrimary, height: 20, width: 20),
                label: language!.downloads,
              ),
              NavigationDestination(
                icon:
                    Icon(Icons.bookmark_border, size: 26, color: Colors.white),
                selectedIcon:
                    Icon(Icons.bookmark_border, color: colorPrimary, size: 26),
