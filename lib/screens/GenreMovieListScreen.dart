                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: [
                                    if (data.runTime.validate().isNotEmpty)
                                      Text(
                                    ...
                                    if (data.censorRating.validate().isNotEmpty || data.isHD.validate())
                                      Row(
                                        children: <Widget>[
                                          if (data.isHD.validate()) hdWidget(context).paddingRight(spacing_standard),
                                          if (data.censorRating.validate().isNotEmpty)
                                            Container(
                                              child: Text(data.censorRating.validate(), style: boldTextStyle(color: Colors.black, size: 10)),
                                              padding: EdgeInsets.all(2),
                                              decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(4)),
                                            ),
                                          itemSubTitle(context, getYear(data.releaseDate.validate()), fontSize: 12).paddingLeft(4),
                                        ],
                                      ),
                                  ],
                                ),
